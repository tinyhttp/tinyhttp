...
- `outputConfiguartion.output` - function that recieves the log generated by the logger.
- `outputConfiguartion.color` - property that determines if the logger will generate a message with color. usefull for logging into the console, disable it if logging into file / http / etc...
