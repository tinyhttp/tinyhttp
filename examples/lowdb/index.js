...
// get post by id
app.get('/:id', (req, res) => {
  const currentPost = posts.find((post) => post.id === Number.parseInt(req.params.id, 10))
  if (currentPost) {
...
app.delete('/:id', (req, res) => {
  const currentPost = posts.filter((post) => post.id !== Number.parseInt(req.params.id, 10))
